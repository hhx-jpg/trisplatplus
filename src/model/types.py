...
class Triangles:
    ...
    # Optional local RGB texture tile per triangle, [B, N, 3, T, T].
    texture_colors: Optional[Float[Tensor, "batch num_points 3 texture_h texture_w"]] = None
    texture_alphas: Optional[Float[Tensor, "batch num_points texture_h texture_w"]] = None
